...
from System.TimeZoneInfo import TransitionTime
...
class Nullable(ABC, Object):
    ...
    @classmethod
    def Compare(cls, n1: Optional[T], n2: Optional[T]) -> int:
        """
    ...
    @classmethod
    @overload
    def Equals(cls, n1: Optional[T], n2: Optional[T]) -> bool:
        """
...
class Nullable(Generic[T], ValueType):
    ...
    def ToString(self) -> str:
        ...
        """
    @classmethod
    def op_Explicit(cls, value: Optional[T]) -> T:
        """"""
    @classmethod
...
class TupleExtensions(ABC, Object):
    ...
    def Deconstruct(
        cls,
        value: Tuple[
            T1, T2, T3, T4, T5, T6, T7, Tuple, T9, T10, T11, T12, T13, T14, Tuple, T16, T17
        ],
        item1: T1,
        item2: T2,
        item3: T3,
    ...
    def Deconstruct(
        cls,
        value: Tuple[
            T1, T2, T3, T4, T5, T6, T7, Tuple, T9, T10, T11, T12, T13, T14, Tuple, T16, T17, T18
        ],
        item1: T1,
        item2: T2,
        item3: T3,
    ...
    def ToTuple(
        ...
        T1, T2, T3, T4, T5, T6, T7, Tuple, T9, T10, T11, T12, T13, T14, Tuple, T16, T17, T18, T19
    ]:
        """
    ...
    def ToTuple(
        cls,
        value: ValueTuple[
            T1, T2, T3, T4, T5, T6, T7, ValueTuple, T9, T10, T11, T12, T13, T14, ValueTuple, T16
        ],
    ...
    @overload
    def ToTuple(
        cls, value: ValueTuple[T1, T2, T3, T4, T5, T6, T7, ValueTuple, T9, T10, T11, T12, T13, T14]
    ...
    @overload
    def ToTuple(
        cls, value: ValueTuple[T1, T2, T3, T4, T5, T6, T7, ValueTuple, T9, T10, T11, T12, T13]
    ...
    @overload
    def ToTuple(
        cls, value: ValueTuple[T1, T2, T3, T4, T5, T6, T7, ValueTuple, T9, T10, T11, T12]
    ...
    def ToValueTuple(
        ...
        T1, T2, T3, T4, T5, T6, T7, ValueTuple, T9, T10, T11, T12, T13, T14, ValueTuple, T16, T17
    ]:
        """
    ...
    @overload
    def ToValueTuple(
        cls, value: Tuple[T1, T2, T3, T4, T5, T6, T7, Tuple, T9, T10, T11, T12, T13, T14]
...
class __HResults(ABC, Object):
    ...
    def ToString(self) -> str:
        ...
        :return:
        """
    passclass UriIdnScope(System.Enum, int):
    None: Enum = ...
    AllExceptIntranet: Enum = ...
    All: Enum = ...
...
class UriIdnScope(System.Enum, int):
    None: UriIdnScope = ...
    AllExceptIntranet: UriIdnScope = ...
    All: UriIdnScope = ...
