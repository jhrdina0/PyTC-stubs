...
class LabelSystemPathInput:
    """
            ...
            The LabelSystemPathInput structure is used to hold a single UID of the object of
            type Imp0LabelDesignRevision, Pka0DigitalAssetRevision or Imd0MedDevIdfrRevision
            and its corresponding LS Path attribute.
            
    """
    def __init__(self, ) -> None: ...
    Uid: str
    """
            The UID of object type: Imp0LabelDesignRevision, Pka0DigitalAssetRevision
            or Imd0MedDevIdfrRevision.
            """
    LabelSystemPath: str
    """LS Path unique attribute of the object as maintained by the Label Management System."""
...
class LabelManagement:
    ...
    def UpdateLabelSystemPaths(self, LabelSystemPathsInput: list[LabelSystemPathInput]) -> Teamcenter.Soa.Client.Model.ServiceData:
        """    
