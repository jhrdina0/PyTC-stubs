import Sas0.Services.Strong.Svcautoscheduling._2014_06.SvcAutoScheduling
import System
...
class SvcAutoSchedulingRestBindingStub(SvcAutoSchedulingService):
    ...
    def IdentifyDiscrepancies(self, SelectedAsmBomLine: Teamcenter.Soa.Client.Model.Strong.AsMaintainedBOMLine) -> Sas0.Services.Strong.Svcautoscheduling._2014_06.SvcAutoScheduling.RelatedDiscrepancies: ...
    def IdentifyServicePlans(self, SelectedAsmLine: Teamcenter.Soa.Client.Model.Strong.AsMaintainedBOMLine) -> Sas0.Services.Strong.Svcautoscheduling._2014_06.SvcAutoScheduling.RelatedServicePlans: ...
    def PopulateServiceSchedule(self, RequirementInfo: list[Sas0.Services.Strong.Svcautoscheduling._2014_06.SvcAutoScheduling.RequirementInformation], DiscrepancyList: list[Teamcenter.Soa.Client.Model.Strong.ServiceDiscrepancy], MaList: list[Teamcenter.Soa.Client.Model.Strong.ServiceActivity], WorkOrder: Teamcenter.Soa.Client.Model.Strong.Item, SelectedPhyPartRev: Teamcenter.Soa.Client.Model.Strong.PhysicalPartRevision, TopPhyPartRev: Teamcenter.Soa.Client.Model.Strong.PhysicalPartRevision, IsRegenerate: bool, RunInBackground: bool) -> Teamcenter.Soa.Client.Model.ServiceData: ...
...
SAS0SoaSvcAutoSchedulingStrong.dll
            


    """
    @staticmethod
    def getService(connection: Teamcenter.Soa.Client.Connection) -> SvcAutoSchedulingService:
